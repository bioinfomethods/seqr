...
const PaMoiFilter = ({ shouldShow, shouldDisable, iconColor, label, filterComponent, ...props }) => {
  // console.log(props)
  return (
    <FormSpy subscription={SUBSCRIPTION}>
      {({ values }) => {
        // console.log('values', values)
        return (!shouldShow || shouldShow(values?.search?.locus || {})) && createElement(
