...
from seqr.views.apis.dataset_api import add_variants_dataset_handler, add_clickhouse_dataset_handler
...
api_endpoints = {
    ...
    'project/(?P<project_guid>[^/]+)/add_clickhouse_dataset': add_clickhouse_dataset_handler,
