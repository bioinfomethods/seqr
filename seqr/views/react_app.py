...
from settings import SEQR_VERSION, CSRF_COOKIE_NAME, DEBUG, LOGIN_URL, GA_TOKEN_ID, ANVIL_LOADING_DELAY_EMAIL_START_DATE, ARCHIE_API_ROOT_URL, MCRI_ARCHIE_DOCS_URL_PATH
...
def render_app_html(request, additional_json=None, include_user=True, status=200):
    ...
    initial_json = {'meta':  {
        ...
        'archieDocsUrlPath': MCRI_ARCHIE_DOCS_URL_PATH,
