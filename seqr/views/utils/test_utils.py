...
PARSED_VARIANTS = [
    {
        ...
        'predictions': {'splice_ai': 0.75, 'eigen': None, 'revel': None, 'mut_taster': None, 'fathmm': 'D',
                        ...
                        'mpc': None, 'strvctvre': None, 'genetale_var_class_num': None, 'genetale_gene_class_info': [],
                        'splice_ai_consequence': None, 'gnomad_noncoding': 1.01272,
                        'am_genome': 'hg38', 'am_uniprot_id': 'Q9UQ52',
                        'am_transcript_id': 'ENST00000446702.7', 'am_protein_variant': 'F150S',
                        'am_pathogenicity': 0.3142, 'am_class': 'likely_benign',
                        },
        'ref': 'TC',
        'rsid': None,
    ...
    },
    {
        ...
        'predictions': {
            ...
            'mpc': None, 'strvctvre': None, 'splice_ai_consequence': None, 'genetale_var_class_num': None,
            'genetale_gene_class_info': [],
            'am_genome': None, 'am_uniprot_id': None,
            'am_transcript_id': None, 'am_protein_variant': None,
...
PARSED_SV_VARIANT = {
    ...
    'predictions': {'splice_ai': None, 'eigen': None, 'revel': None, 'mut_taster': None, 'fathmm': None,
                    ...
                    'genetale_var_class_num': None, 'genetale_gene_class_info': [],
                    'am_genome': None, 'am_uniprot_id': None,
                    'am_transcript_id': None, 'am_protein_variant': None,
                    'am_pathogenicity': None, 'am_class': None,
                    },
...
PARSED_SV_WGS_VARIANT = {
    ...
    'predictions': {'splice_ai': None, 'eigen': None, 'revel': None, 'mut_taster': None, 'fathmm': None,
                    ...
                    'polyphen': None, 'dann': None, 'sift': None, 'cadd': None, 'primate_ai': None,
                    'mpc': None, 'strvctvre': None, 'genetale_var_class_num': None, 'genetale_gene_class_info': [],
                    'gnomad_noncoding': None, 'splice_ai_consequence': None,
                    'am_genome': None, 'am_uniprot_id': None,
                    'am_transcript_id': None, 'am_protein_variant': None,
                    'am_pathogenicity': None, 'am_class': None,
                    },
