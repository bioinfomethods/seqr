...
echo "  PostgreSQL:     $POSTGRES_SERVICE_HOSTNAME:$POSTGRES_SERVICE_PORT"
echo "  ClickHouse:     $CLICKHOUSE_SERVICE_HOSTNAME:$CLICKHOUSE_SERVICE_PORT"
echo "  ElasticSearch:  $ELASTICSEARCH_SERVICE_HOSTNAME:$ELASTICSEARCH_SERVICE_PORT"
echo "  Redis:          $REDIS_SERVICE_HOSTNAME:$REDIS_SERVICE_PORT"
echo ""
