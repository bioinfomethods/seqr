...
class PaLocusListAPITest(AuthenticationTestCase):
    ...
    def _assert_lists_imported(self):
        ...
        self.assertDictEqual(locus_lists_dict[NEW_AU_PA_LOCUS_LIST_GUID], {
            ...
            'items': [{'geneId': 'ENSG00000090861'}],
            'paLocusList': {'url': 'https://test-panelapp.url.au/api/panels/3069/genes', 'panelAppId': 3069},
            'numEntries': 1, 'numProjects': 0, 'isPublic': True, 'createdBy': None, 'canEdit': False,
            'createdDate': mock.ANY, 'lastModifiedDate': mock.ANY, 'intervalGenomeVersion': None,
        })
        self.assertDictEqual(locus_lists_dict[NEW_UK_PA_LOCUS_LIST_GUID], {
            ...
            'items': [{'geneId': 'ENSG00000139734'}],
            'paLocusList': {'url': 'https://test-panelapp.url.uk/api/panels/260/genes',
                            'panelAppId': 260}, 'numEntries': 1, 'numProjects': 0, 'isPublic': True, 'createdBy': None,
